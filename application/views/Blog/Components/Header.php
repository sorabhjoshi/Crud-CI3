    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            <div class="sidebar-content">
                <a class="headerimg" href="<?= base_url('Dashboard') ?>"><img
                ...
                <div class="dropdown-container">
                    <a href="<?php echo base_url('UserDetails/' . htmlspecialchars($this->session->userdata('id'))) ?>">My
                        Profile</a>
                    <a
                        href="<?php echo base_url('UserDetailsEdit/' . htmlspecialchars($this->session->userdata('id'))) ?>">Update
                        Profile</a>
                ...
                <a href="<?php echo base_url('Company') ?>">Company Profile</a>
