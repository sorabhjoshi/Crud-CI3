...
// Assuming $blog is already fetched from the database
?>
  ...
  <div class="container my-5">
    ...
    <div class="text-center">
      <?php if (!empty($blog['Image'])): ?>
        <img src="<?= base_url('uploads/blog_images/' . $blog['Image']); ?>" class="img-fluid mb-4" alt="<?= htmlspecialchars($blog['Title']); ?>">
      <?php else: ?>
    ...
    <div class="text-center">
      <a href="<?php echo base_url('Blog_website/Blogs')?>" class="btn btn-primary mt-4">Back to Blogs</a>
    </div>
  </div>
</main>
<style>
